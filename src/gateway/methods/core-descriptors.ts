...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["family.invites.create", "family-invites", "operator.admin", "2026.9"],
  ["family.invites.redeem", "family-invites", "operator.admin", "2026.9"],
  ["family.invites.revoke", "family-invites", "operator.admin", "2026.9"],
  ["family.invites.status", "family-invites", "operator.admin", "2026.9"],
