...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["agent.invitations.create", "agent-invitations", "operator.admin", "2026.9"],
  ["agent.invitations.redeem", "agent-invitations", "operator.admin", "2026.9"],
  ["agent.invitations.revoke", "agent-invitations", "operator.admin", "2026.9"],
  ["agent.invitations.status", "agent-invitations", "operator.admin", "2026.9"],
  ["family.agents.adopt", "family-agents", "operator.admin", "2026.9", CONTROL_PLANE_WRITE],
  ["family.agents.list", "family-agents", "operator.admin", "2026.9"],
  ["family.agents.updateGrants", "family-agents", "operator.admin", "2026.9", CONTROL_PLANE_WRITE],
  [
