...
import type * as FamilySchema from "./schema/family.js";
...
export type GatewayCoreRequestParams = {
  "family.invites.create": FamilySchema.FamilyInvitesCreateParams;
  "family.invites.redeem": FamilySchema.FamilyInvitesRedeemParams;
  "family.invites.revoke": FamilySchema.FamilyInvitesRevokeParams;
  "family.invites.status": FamilySchema.FamilyInvitesStatusParams;
