...
enum class GatewayMethod(
  ...
  FamilyInvitesCreate("family.invites.create"),
  FamilyInvitesRedeem("family.invites.redeem"),
  FamilyInvitesRevoke("family.invites.revoke"),
  FamilyInvitesStatus("family.invites.status"),
