...
enum class GatewayMethod(
  ...
  AgentInvitationsCreate("agent.invitations.create"),
  AgentInvitationsRedeem("agent.invitations.redeem"),
  AgentInvitationsRevoke("agent.invitations.revoke"),
  AgentInvitationsStatus("agent.invitations.status"),
  FamilyAgentsAdopt("family.agents.adopt"),
  FamilyAgentsList("family.agents.list"),
  FamilyAgentsUpdateGrants("family.agents.updateGrants"),
  FamilyInvitationsRegenerate("family.invitations.regenerate"),
